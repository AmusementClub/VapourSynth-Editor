...
JOB_SERVER_DIRECTORY = ../../vsedit-job-server
JOB_WATCHER_DIRECTORY = ../../vsedit-job-server-watcher
COMMON_DIRECTORY = ../..
...
FORMS += $${JOB_WATCHER_DIRECTORY}/src/jobs/job_edit_dialog.ui
FORMS += $${JOB_WATCHER_DIRECTORY}/src/connect_to_server_dialog.ui
FORMS += $${JOB_WATCHER_DIRECTORY}/src/trusted_clients_addresses_dialog.ui
FORMS += $${JOB_WATCHER_DIRECTORY}/src/watcher_main_window.ui
...
HEADERS += $${JOB_WATCHER_DIRECTORY}/src/jobs/jobs_model.h
HEADERS += $${JOB_WATCHER_DIRECTORY}/src/jobs/job_edit_dialog.h
HEADERS += $${JOB_WATCHER_DIRECTORY}/src/jobs/job_dependencies_delegate.h
HEADERS += $${JOB_WATCHER_DIRECTORY}/src/jobs/job_state_delegate.h
HEADERS += $${JOB_WATCHER_DIRECTORY}/src/connect_to_server_dialog.h
HEADERS += $${JOB_WATCHER_DIRECTORY}/src/trusted_clients_addresses_dialog.h
HEADERS += $${JOB_WATCHER_DIRECTORY}/src/watcher_main_window.h

HEADERS += $${JOB_SERVER_DIRECTORY}/src/jobs/job_definitions.h
HEADERS += $${JOB_SERVER_DIRECTORY}/src/jobs/jobs_manager.h
HEADERS += $${JOB_SERVER_DIRECTORY}/src/job_server.h
...
SOURCES += $${JOB_SERVER_DIRECTORY}/src/jobs/jobs_manager.cpp
SOURCES += $${JOB_SERVER_DIRECTORY}/src/job_server.cpp
#SOURCES += $${JOB_SERVER_DIRECTORY}/src/main.cpp

SOURCES += $${COMMON_DIRECTORY}/common-src/application_instance_file_guard/application_instance_file_guard.cpp
SOURCES += $${JOB_WATCHER_DIRECTORY}/src/jobs/jobs_model.cpp
SOURCES += $${JOB_WATCHER_DIRECTORY}/src/jobs/job_edit_dialog.cpp
SOURCES += $${JOB_WATCHER_DIRECTORY}/src/jobs/job_dependencies_delegate.cpp
SOURCES += $${JOB_WATCHER_DIRECTORY}/src/jobs/job_state_delegate.cpp
SOURCES += $${JOB_WATCHER_DIRECTORY}/src/connect_to_server_dialog.cpp
SOURCES += $${JOB_WATCHER_DIRECTORY}/src/trusted_clients_addresses_dialog.cpp
SOURCES += $${JOB_WATCHER_DIRECTORY}/src/watcher_main_window.cpp
#SOURCES += $${JOB_WATCHER_DIRECTORY}/src/main.cpp

#SOURCES += $${PROJECT_DIRECTORY}/src/main.cpp
SOURCES += full.cpp
SOURCES += vsedit-main.cpp
SOURCES += vsedit-job-server-watcher.cpp
SOURCES += vsedit-job-server.cpp
